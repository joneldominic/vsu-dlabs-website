                    ...
                    if(breadcrumb_customer_type=="free")
                        {
                            ...
                            echo 'You are using <strong> '.breadcrumb_customer_type.' version  '.breadcrumb_plugin_version.'</strong> of <strong>'.breadcrumb_plugin_name.'</strong>, To get more feature you could try our premium version. ';
                    ...
                    else
                        {
                            ...
                            echo 'Thanks for using <strong> premium version  '.breadcrumb_plugin_version.'</strong> of <strong>'.breadcrumb_plugin_name.'</strong> version '.breadcrumb_plugin_version;
